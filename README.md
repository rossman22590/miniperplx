...
🔗 **[Try Datavibes at scira.ai](https://mydatavibes.com)**
...
## Set Datavibes as your default search engine
...
5. **Set the search engine URL**:
   - Enter `https://mydatavibes.com?q=%s` in the "URL with %s in place of query" field.
...
After completing these steps, you should be able to use Datavibes as your default search engine in Chrome.
