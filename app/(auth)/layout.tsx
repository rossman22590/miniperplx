                ...
                <CarouselContent>
                  {testimonials.map((testimonial, index) => (
                    <CarouselItem key={index}>
                      <Link href={testimonial.link} target="_blank" className="block group/testimonial">
                        <div className="pr-4">
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`h-px transition-all duration-500 ${
                      index === current ? 'w-8 bg-foreground' : 'w-4 bg-foreground/20 hover:bg-foreground/40'
                    }`}
