    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:text-foreground/80 prose-headings:tracking-tight">
          <p className="text-lg">
            Welcome to Datavibes AI. These Terms of Service govern your use of our website and services. By using Datavibes AI,
          ...
          <p>
            ...
            be effective immediately upon posting. Your continued use of Datavibes AI after any modifications indicates your
            acceptance of the modified terms.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            Datavibes AI is a minimalistic AI-powered search engine that helps users find information on the internet. Our
          ...
          <p>
            ...
            Datavibes AI should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All content, features, and functionality of Datavibes AI, including but not limited to text, graphics, logos,
            icons, images, audio clips, and software, are the property of Datavibes AI or its licensors and are protected by
          ...
          <p>
            By using Datavibes AI, you acknowledge and agree that your data may be processed by these third-party services
          ...
          <ul>
            ...
            <li>
              <strong>Datavibes Pro:</strong> $15/month subscription with unlimited searches and access to all AI models
            </li>
          </ul>
          <p>
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of Datavibes AI is also governed by our{' '}
          ...
          <p>
            To the maximum extent permitted by law, Datavibes AI shall not be liable for any indirect, incidental, special,
          ...
          <p>
            We reserve the right to suspend or terminate your access to Datavibes AI, with or without notice, for conduct
          ...
          <p>
            ...
            Datavibes AI operates, without regard to its conflict of law provisions.
          </p>
          ...
          <div className="my-8 border-t pt-8">
            <p className="text-sm text-muted-foreground">
              By using Datavibes AI, you agree to these Terms of Service and our{' '}
              <Link href="/privacy-policy" className="underline">
                Privacy Policy
              </Link>
              .
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} Datavibes AI by Zaid Mukaddam
              </div>
            </div>
