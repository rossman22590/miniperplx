...
export const serverEnv = createEnv({
  server: {
    ...
    STRIPE_PRICE_PRO_MONTHLY_INR: z.string().optional(),
    STRIPE_PRICE_PRO_MONTHLY_STUDENT: z.string().optional(),
    STRIPE_PRICE_PRO_MONTHLY_STUDENT_INR: z.string().optional(),
